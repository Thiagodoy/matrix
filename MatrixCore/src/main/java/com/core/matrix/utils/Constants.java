...
public class Constants {
    ...
    public static final String TASK_VARIABLE = "TASK_VARIABLE";
    ...
    public static final String CONTENT_ID_LAYOUT_A = "Tipo de Relatório: Medidas Consolidadas";
    public static final String CONTENT_ID_LAYOUT_B = "Tipo de Relatório: Origem de Dados da Coleta";
    ...
    public static final String TEMPLATE_PARAM_CONTRACT = ":contract";
    ...
    public static final String GROUP_MANAGER_PORTAL = "profile-gestor-portal";
    ...
    public static final String TASK_LABEL_CONTRACT = "task-label-contract";
